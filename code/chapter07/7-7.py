...
class MyWebSocketHandler(Tornados.websocket.WebSocketHandler):
...
def sendTime():
    ...
    while True:
        for key in clients.keys():
            ...
            clients[key]["object"].write_message(msg.encode('utf-8'))
...
if __name__ == '__main__':
    ...
    Tornados.ioloop.IOLoop.instance().start()  # 挂起运行
