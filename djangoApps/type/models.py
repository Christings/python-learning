...
class Type2(models.Model):
    ...
    二类目录
    '''
    parent = models.ForeignKey(Type1, verbose_name="父类级别", null=True, blank=True, on_delete=models.CASCADE)
    name = models.CharField(max_length=10, default="", verbose_name="类目名")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class Type3(models.Model):
    ...
    三类目录
    '''
    parent = models.ForeignKey(Type2, verbose_name="父类级别", null=True, blank=True, on_delete=models.CASCADE)
    name = models.CharField(max_length=10, default="", verbose_name="类目名")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class Type4(models.Model):
    ...
    四类目录
    '''
    parent = models.ForeignKey(Type3, verbose_name="父类级别", null=True, blank=True, on_delete=models.CASCADE)
    name = models.CharField(max_length=10, default="", verbose_name="类目名")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
